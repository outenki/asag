...
def create_model(args, initial_mean_value, overal_maxlen, vocab):
    ...
    if args.model_type == 'cls':
        ...
        # param: keras.layers.Embedding(input_dim, output_dim, embeddings_initializer='uniform', embeddings_regularizer=None, 
        ...
        if args.rnn_dim > 0:
            # params: keras.layers.GRU(units, activation='tanh', recurrent_activation='hard_sigmoid', use_bias=True, 
            ...
            # dropout_W: dropout of output
            # dropout_U: dropout of recurrent connections
            model.add(RNN(args.rnn_dim, return_sequences=False, dropout_W=dropout_W, dropout_U=dropout_U))
        if args.dropout_prob > 0:
            # param: keras.layers.Dropout(rate, noise_shape=None, seed=None)
            # the args.dropout_prob is defaultly set as 0.5
